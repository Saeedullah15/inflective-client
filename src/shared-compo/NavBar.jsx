...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        {
            user && <ul className='flex flex-col lg:flex-row'>
    ...
    return (
        <>
            <div className='block md:hidden bg-gray-200'>
                <a href='/' className="text-2xl font-bold flex justify-between mx-2 items-center">
                    <img src={logo} className='w-4 mr-2' alt="" />
                    Inflective
                </a>
            </div>
